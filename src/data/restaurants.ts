...
export const restaurants: Restaurant[] = [
  ...
  {
    id: 'waiahole-poi-factory',
    name: 'Waiahole Poi Factory',
    neighborhood: 'Windward Coast',
    category: 'Plate Lunch Legends',
    rating: 4.6,
    price: '$',
    description: "A working poi factory in a 1905 wooden building at the mouth of Waiahole Valley, serving the most authentic Hawaiian plate lunches on the Windward side. The Hoe family has run this roadside institution for decades, steaming laulau and slow-smoking kalua pig with ingredients raised right in the valley. Order at the window, grab a picnic table, and don't skip the hand-pounded poi.",
    address: '48-140 Kamehameha Hwy, Kaneohe, HI 96744',
    phone: '(808) 239-2222',
    hours: 'Wed-Mon: 10AM-6PM, Closed Tue',
    mustTry: ['Kanaka Nui Plate', 'Kalua Pig', 'Laulau', 'Squid Luau', 'Hand-Pounded Poi'],
    image: '/images/waiahole-poi-factory.jpg',
    tags: ['Hawaiian food', 'takeout', 'historic', 'poi', 'windward', 'cash friendly'],
  },
  {
    id: 'hale-vietnam',
    name: 'Hale Vietnam',
    ...
    rating: 4.3,
    price: '$$',
    description: "Kaimuki's beloved Vietnamese standby, tucked into a residential block of 12th Avenue and packed with neighborhood regulars at lunch. The pho broth is the star — rich, aromatic, and consistently praised as some of the best in town — alongside shatteringly crisp imperial rolls. Fair warning: the large pho is genuinely enormous, and locals bring a sweater for the arctic air conditioning.",
    address: '1140 12th Ave, Honolulu, HI 96816',
    phone: '(808) 735-7581',
    hours: 'Tue-Sun: 10AM-9:45PM, Closed Mon',
    mustTry: ['Pho Dac Biet', 'Imperial Rolls', 'Summer Rolls', 'BBQ Pork Vermicelli'],
    image: '/images/hale-vietnam.jpg',
    tags: ['vietnamese', 'pho', 'Kaimuki', 'family-run', 'lunch', 'dinner'],
  },
  {
    id: 'yamas-fish-market',
    name: "Yama's Fish Market",
    neighborhood: 'Honolulu',
    category: 'Local Institutions',
    rating: 4.6,
    price: '$',
    description: "A Moiliili institution since 1980, Yama's is takeout-only Hawaiian comfort food at its finest — three generations of local families have grown up on its laulau and kalua pig. The poke is outstanding, and the crispy ahi poke patties are a cult favorite. Save room for the famous haupia sweet potato pie waiting in the refrigerated case.",
    address: '2332 Young St, Honolulu, HI 96826',
    phone: '(808) 941-9994',
    hours: 'Tue-Thu & Sun: 9AM-5PM, Fri-Sat: 9AM-7PM, Closed Mon',
    mustTry: ['Lau Lau Plate', 'Kalua Pig', 'Ahi Poke Patties', 'Haupia Sweet Potato Pie'],
    image: '/images/yamas-fish-market.jpg',
    tags: ['Hawaiian food', 'poke', 'takeout', 'dessert', 'Moiliili', 'local favorite'],
  },
  {
    id: 'irifune',
    name: 'Irifune',
    ...
    rating: 4.4,
    price: '$$',
    description: "The legendary Kapahulu hole-in-the-wall that sparked Oahu's garlic ahi obsession, reborn as a downtown takeout counter on Mililani Street. Office workers line up at 11 sharp for seared ahi, breaded tofu with the famous ginger-tori sauce, and bento deals that feel like a delicious time warp. Lunch only and cooked to order — worth every minute of the wait.",
    address: '850 Mililani St, Honolulu, HI 96813',
    phone: '(808) 737-1141',
    hours: 'Mon-Fri: 11AM-2PM (lunch only)',
    mustTry: ['Garlic Ahi', 'Breaded Tofu with Ginger-Tori Sauce', 'Seared Ahi Tataki', 'Chicken Karaage', 'Hambagu with Ponzu'],
    image: '/images/irifune.jpg',
    tags: ['japanese', 'garlic ahi', 'takeout', 'downtown', 'lunch', 'local legend'],
  },
  {
    id: 'fresh-catch',
    name: 'Fresh Catch',
    ...
    rating: 4.5,
    price: '$$',
    description: "Chef Reno Henriques' Kapahulu seafood counter is where Honolulu goes for poke — twenty-plus varieties made fresh daily, alongside the famous keawe-smoked meat with onions. The ahi katsu and crab-stuffed ahi roll have cult followings of their own. Grab a poke bowl and the quirky, addictive Dorito green salad and thank us later.",
    address: '1113 Kapahulu Ave, Honolulu, HI 96816',
    phone: '(808) 737-9633',
    hours: 'Tue-Sat: 10AM-6PM, Sun: 10AM-4PM, Closed Mon',
    mustTry: ['Poke Bowl', 'Smoked Meat with Onions', 'Ahi Katsu', 'Crab Stuffed Ahi Roll', 'Furikake Salmon'],
    image: '/images/fresh-catch.jpg',
    tags: ['poke', 'seafood', 'smoked meat', 'takeout', 'Kapahulu', 'plate lunch'],
  },
];
