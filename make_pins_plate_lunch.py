"""Add Pinterest text overlays for the plate lunch pins per Ono Oahu pin spec."""
...
make_pin(
    "public/images/pin-plate-lunch-1-clean.jpg",
    "public/images/pinterest-pin-plate-lunch-1.jpg",
    "The 10 Best Plate Lunches on Oahu",
    "From Rainbow Drive-In to North Shore garlic shrimp — where locals eat",
    "onooahu.com",
)
make_pin(
    "public/images/pin-plate-lunch-2-clean.jpg",
    "public/images/pinterest-pin-plate-lunch-2.jpg",
    "Oahu Plate Lunch Guide",
    "Two scoops rice, mac salad, and pure aloha — 10 local legends",
    "onooahu.com",
)
