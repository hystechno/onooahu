"""Convert pin sources to 1000x1500 JPG, add Ono Oahu text overlays."""
import os
...
prep(f"{IMG}/pin-family-restaurants-1-src.png", f"{IMG}/pin-family-restaurants-1-clean.jpg")
prep(f"{IMG}/pin-family-restaurants-2-src.png", f"{IMG}/pin-family-restaurants-2-clean.jpg")

make_pin(
    f"{IMG}/pin-family-restaurants-1-clean.jpg",
    f"{IMG}/pinterest-pin-family-restaurants-1.jpg",
    "10 Best Family Restaurants on Oahu",
    "Kid-approved spots from Waikiki to the North Shore",
    "onooahu.com",
)
make_pin(
    f"{IMG}/pin-family-restaurants-2-clean.jpg",
    f"{IMG}/pinterest-pin-family-restaurants-2.jpg",
    "Oahu With Kids: Where to Eat",
    "The 10 best family-friendly restaurants on Oahu",
    "onooahu.com",
)
